INCS = expr.h catch.h parse.h cmdline.h val.h env.h cont.h step.h

OBJS = main.o expr.o parse.o cmdline.o val.o env.o cont.o step.o
...
cont.o : env.cpp $(INCS)
	c++ --std=c++14 -O2 -c cont.cpp

step.o : env.cpp $(INCS)
	c++ --std=c++14 -O2 -c step.cpp
